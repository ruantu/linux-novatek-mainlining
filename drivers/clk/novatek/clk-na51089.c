...
#define NA51089_CGU_ETH_PHY_RESET_MASK		GENMASK(31, 30)
#define NA51089_CGU_ETH_PHY_RESET_ASSERT	0x0
#define NA51089_CGU_ETH_PHY_RESET_DEASSERT	0x3
...
#define NA51089_PLL6_RATE0			0x44e0
...
static const struct novatek_clk_data na51089_early_clocks[] = {
	{
		...
		.id = NOVATEK_CLK_NO_ID,
		.hw_id = NA51089_SOURCE_PLL6,
		.parents = { NA51089_SOURCE_OSC },
		.num_parents = 1,
		.pll.rate0 = NA51089_PLL6_RATE0,
		.pll.enable_reg = NA51089_PLL_ENABLE,
		.pll.status_reg = NA51089_PLL_STATUS,
		.pll.enable_mask = NA51089_CGU_PLL_ENABLE_MASK(6),
		.pll.enable_value = FIELD_PREP_CONST(
			NA51089_CGU_PLL_ENABLE_MASK(6),
			NA51089_CGU_PLL_ENABLE),
		.pll.ready_mask = NA51089_CGU_PLL_STATUS_MASK(6),
		.pll.ready_value = FIELD_PREP_CONST(
			NA51089_CGU_PLL_STATUS_MASK(6),
			NA51089_CGU_PLL_READY),
	}, {
		.name = "na51089-pll6-div6",
		.type = NOVATEK_CLK_FIXED_FACTOR,
		.id = NOVATEK_CLK_NO_ID,
		.hw_id = NA51089_SOURCE_PLL6_DIV6,
		.parents = { NA51089_SOURCE_PLL6 },
		.num_parents = 1,
		.factor.mult = 1,
		.factor.div = 6,
	}, {
...
static const struct novatek_clk_data na51089_late_clocks[] = {
	{
		...
		.id = NA51089_CLK_ETH,
		.hw_id = NOVATEK_CLK_NO_ID,
		.parents = { NA51089_SOURCE_PLL6_DIV6 },
		.num_parents = 1,
		.gate.reg = NA51089_CLK_EN1,
		.gate.bit = 29,
	}, {
		.name = "na51089-eth-ext-phy",
		.type = NOVATEK_CLK_GATE,
		.id = NA51089_CLK_ETH_EXT_PHY,
		.hw_id = NOVATEK_CLK_NO_ID,
...
static const struct novatek_reset_map na51089_reset_maps[] = {
	...
	[NA51089_RESET_ETH_PHY] = {
		.reg = NA51089_RESET2,
		.mask = NA51089_CGU_ETH_PHY_RESET_MASK,
		.assert_value = FIELD_PREP_CONST(
			NA51089_CGU_ETH_PHY_RESET_MASK,
			NA51089_CGU_ETH_PHY_RESET_ASSERT),
		.deassert_value = FIELD_PREP_CONST(
			NA51089_CGU_ETH_PHY_RESET_MASK,
			NA51089_CGU_ETH_PHY_RESET_DEASSERT),
	},
